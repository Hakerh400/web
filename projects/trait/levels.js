...
const levels = {
  ...
  '07'(world, ent, level){
    createLayout(world, ent, level, `
      ...
      +--------------------+
    `, grid => {
      grid.getp(5, 5).createEnt(Entity.Button);
      // 
    });
  },
};
